...
Animacion1 MACRO charsPerRow, cantRows, bufferImagen ;
    ...
    Ciclo:
        ...
        PrintArt:
            PUSH CX
            PrintCadena1 filaActual, 10, paginaActual, charsPerRow, saltoCadena, 2
            INC filaActual
...
Animacion3 MACRO charsPerRow, cantRows, bufferImagen
    ...
    Ciclo:
        ...
        PrintArt:
            PUSH CX
            PrintCadena1 filaActual, columna, paginaActual, charsPerRow, saltoCadena, 14
            INC filaActual
...
Animacion4 MACRO charsPerRow, cantRows, bufferImagen
    ...
    Ciclo:
        ...
        PrintArt:
            PUSH CX
            PrintCadena1 filaActual, columna, paginaActual, charsPerRow, saltoCadena, 6
            DEC filaActual
